...
class _RecordScreenState extends State<RecordScreen> {
  ...
  int _type = 0; // 0 for Expense, 1 for Income
  ...
  Future<void> _saveRecord() async {
    ...
    // Continuous recording: clear amount and note, keep type and category
    setState(() {
